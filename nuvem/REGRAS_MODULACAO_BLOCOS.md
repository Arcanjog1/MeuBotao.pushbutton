...
## 22. PIPELINE OFICIAL DE ABERTURAS — parede completa primeiro (2026-08-28)
...
### 22.2 O que exatamente mudou no solver
...
### 22.3 Ajuste mínimo (itens 11 a 14) — e a ordem de prioridade
...
### 22.4 Duas correções de REGRA que a nova ordem tornou necessárias
...
### 22.5 Degradação controlada — o único caminho de volta ao `split`
...
### 22.6 O que foi MEDIDO (não suposto)
...
### 22.7 Pendência aberta (DOCUMENTADO — pendência de código)
...
### 22.8 Critérios de aceitação — cobertos por teste
