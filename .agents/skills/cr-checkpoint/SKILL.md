...
Esta Skill gerencia checkpoints operacionais de trabalho para continuidade de sessões do Codex.
...
- **Não Substitui Fontes Canônicas:** Nunca substitui código, testes, `nuvem/REGRAS_MODULACAO_BLOCOS.md`, `AGENTS.md` ou documentação do repositório.
...
- **Git:** checkpoint de entrega deve ser versionado. Rascunhos em
  `.Codex/checkpoints/` sao ignorados e nunca substituem esse registro.
