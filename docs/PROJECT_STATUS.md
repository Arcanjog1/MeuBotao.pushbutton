...
| Área | Estado |
|---|---|
| MAIN / HEAD observado | `a57ddc258aaaf99de6db89d26e257115ba5d7c51` (D9–D13 / §81, código + testes, direto na main; antes `532c1b9` = rótulo da parada D16; antes `af247a7` = D16 investigado; antes `8df42be` = D6 / seção 80; antes `33960a0` = rastreio de L + §76; antes `367eb0c` = ciclo 3 / regra 79; antes `74cf2df` = ciclo 2 / regra 49.1; antes `9376a36` = ciclo 1 / regra 78; antes `ca014aa` = runtime canônico; `4bb88bb` = merge do **#49**; antes `55e990d` = #41; #40 CHANNEL em `61d4f6c`); antes 0e41c8e (#39), ad46c61 (#38), 6439669 (#37), 21576ee (#36), 6c00f7e (#35), aa58d70 (#32) |
...
| Próximo objetivo | Aguardando autorização (D11 — paridade dos T / §72 — e D14 / Etapa 3B não iniciados; candidato seguinte da composição: §68 com guarda de junta); decisões E (topo/peitoril fora da grade) e F (cinta de topo); [pacote Beta 2](architecture/beta2-implementation-package.md) |
