...
| UI candidata | `codex/modulacao-automatica-ui-redesign`, HEAD avaliado `c7db0fe`: etapas, plano antes da criação, logs recolhíveis, relatório, seleção e famílias. **PARTIAL**, smoke Revit/DPI e fase inicial CAD pendentes; nenhuma mudança física. [Entrega](checkpoints/2026-09-16-ui-redesign.md). Sem merge. |
